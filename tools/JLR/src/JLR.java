...
class FileWrite {
    ...
    public FileWrite() throws IOException {
        writer = new BufferedWriter(new FileWriter(JLR.OUTPUT_PATH));
    }
...
public class JLR {
    final static String INPUT_PATH = "input/input";
    final static String OUTPUT_PATH = "output/grammar.lr1";
