...
section .data
	...
	global __class_J1_5_ForwardReference_ArrayLength
__class_J1_5_ForwardReference_ArrayLength:
		global __ref_SIT_J1_5_ForwardReference_ArrayLength
	__ref_SIT_J1_5_ForwardReference_ArrayLength:
		dd 0

		global __ref_PARENTS_J1_5_ForwardReference_ArrayLength
	__ref_PARENTS_J1_5_ForwardReference_ArrayLength:
	...
	; Methods	
		...
		dd __STATIC_method__J1_5_ForwardReference_ArrayLength__test
...
mov ebx, __ref_SIT_J1_5_ForwardReference_ArrayLength
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_5_ForwardReference_ArrayLength__test
	__STATIC_method__J1_5_ForwardReference_ArrayLength__test:
		push ebp
		mov ebp, esp

		;; ---declare j
		;; ---new [J1_5_ForwardReference_ArrayLength] ()
		;; Allocating size of 12
		mov eax, 12
				call __malloc
					mov ebx, __class_J1_5_ForwardReference_ArrayLength
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_5_ForwardReference_ArrayLength__J1_5_ForwardReference_ArrayLength
		add esp, 0
		pop eax

		;; ---end of new [J1_5_ForwardReference_ArrayLength] ()
		...
		jmp _method_return___STATIC_method__J1_5_ForwardReference_ArrayLength__test

		_method_return___STATIC_method__J1_5_ForwardReference_ArrayLength__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_5_ForwardReference_ArrayLength__J1_5_ForwardReference_ArrayLength
	__constructor__J1_5_ForwardReference_ArrayLength__J1_5_ForwardReference_ArrayLength:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
