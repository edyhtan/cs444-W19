...
extern __field_J2_static_decl_foo
...
section .data
	...
	global __class_J2_static_decl
__class_J2_static_decl:
		global __ref_SIT_J2_static_decl
	__ref_SIT_J2_static_decl:
		dd 0

		global __ref_PARENTS_J2_static_decl
	__ref_PARENTS_J2_static_decl:
	...
	; Methods	
		...
		dd __STATIC_method__J2_static_decl__test

;; Static fields
		global __field_J2_static_decl_foo
	__field_J2_static_decl_foo		dd 0
...
mov ebx, __ref_SIT_J2_static_decl
mov [ebx], eax
...
;; Static Field: __field_J2_static_decl_foo
mov eax, 3
mov ebx, __field_J2_static_decl_foo
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J2_static_decl__test
	__STATIC_method__J2_static_decl__test:
		push ebp
		mov ebp, esp

		
		mov eax, __field_J2_static_decl_foo
		mov eax, [eax]

		jmp _method_return___STATIC_method__J2_static_decl__test

		_method_return___STATIC_method__J2_static_decl__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J2_static_decl__J2_static_decl
	__constructor__J2_static_decl__J2_static_decl:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
