...
section .data
	...
	global __class_J1_closestMatchConstructor1
__class_J1_closestMatchConstructor1:
		global __ref_SIT_J1_closestMatchConstructor1
	__ref_SIT_J1_closestMatchConstructor1:
		dd 0

		global __ref_PARENTS_J1_closestMatchConstructor1
	__ref_PARENTS_J1_closestMatchConstructor1:
	...
	; Methods	
		...
		dd __STATIC_method__J1_closestMatchConstructor1__test
...
mov ebx, __ref_SIT_J1_closestMatchConstructor1
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_closestMatchConstructor1__test
	__STATIC_method__J1_closestMatchConstructor1__test:
		push ebp
		mov ebp, esp

		;; field access
		;; ---new [J1_closestMatchConstructor1] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_closestMatchConstructor1
		mov [eax], ebx
		...
		;; Pushing args:
			...
			;; Pushing args:
			call __constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1
			add esp, 0
			pop eax

			;; ---end of new [J1_closestMatchConstructor1] ()
			push eax

		call __constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1$J1_closestMatchConstructor1$
		add esp, 4
		pop eax

		;; ---end of new [J1_closestMatchConstructor1] ()
		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J1_closestMatchConstructor1__test

		_method_return___STATIC_method__J1_closestMatchConstructor1__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1
	__constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
...
;; Epilogue
		...
		pop ebp
		ret
		global __constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1$java_lang_Object$
	__constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1$java_lang_Object$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
...
;; Epilogue
		...
		pop ebp
		ret
		global __constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1$J1_closestMatchConstructor1$
	__constructor__J1_closestMatchConstructor1__J1_closestMatchConstructor1$J1_closestMatchConstructor1$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
