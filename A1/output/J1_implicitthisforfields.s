...
section .data
	...
	global __class_J1_implicitthisforfields
__class_J1_implicitthisforfields:
		global __ref_SIT_J1_implicitthisforfields
	__ref_SIT_J1_implicitthisforfields:
		dd 0

		global __ref_PARENTS_J1_implicitthisforfields
	__ref_PARENTS_J1_implicitthisforfields:
	...
	; Methods	
		...
		dd __STATIC_method__J1_implicitthisforfields__test
		dd __method__J1_implicitthisforfields__m
...
;; -----Methods-----
		global __method__J1_implicitthisforfields__m
	__method__J1_implicitthisforfields__m:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___method__J1_implicitthisforfields__m

		_method_return___method__J1_implicitthisforfields__m:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_implicitthisforfields
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_implicitthisforfields__test
	__STATIC_method__J1_implicitthisforfields__test:
		push ebp
		mov ebp, esp

		;; ---Method Invocation: 
		;; Primary.id(ArgList)
			;; ---new [J1_implicitthisforfields] ()
			;; Allocating size of 8
			mov eax, 8
						call __malloc
							mov ebx, __class_J1_implicitthisforfields
			mov [eax], ebx
			...
			;; Pushing args:
			call __constructor__J1_implicitthisforfields__J1_implicitthisforfields
			add esp, 0
			pop eax

			;; ---end of new [J1_implicitthisforfields] ()
		cmp eax, 0
		je __exception
		push eax
		...
		jmp _method_return___STATIC_method__J1_implicitthisforfields__test

		_method_return___STATIC_method__J1_implicitthisforfields__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_implicitthisforfields__J1_implicitthisforfields
	__constructor__J1_implicitthisforfields__J1_implicitthisforfields:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
