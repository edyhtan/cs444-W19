...
section .data
	...
	global __class_J1_typecheck_constructor_invocation
__class_J1_typecheck_constructor_invocation:
		global __ref_SIT_J1_typecheck_constructor_invocation
	__ref_SIT_J1_typecheck_constructor_invocation:
		dd 0

		global __ref_PARENTS_J1_typecheck_constructor_invocation
	__ref_PARENTS_J1_typecheck_constructor_invocation:
	...
	; Methods	
		...
		dd __STATIC_method__J1_typecheck_constructor_invocation__test
...
mov ebx, __ref_SIT_J1_typecheck_constructor_invocation
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_typecheck_constructor_invocation__test
	__STATIC_method__J1_typecheck_constructor_invocation__test:
		push ebp
		mov ebp, esp

		;; ---new [J1_typecheck_constructor_invocation] ()
		;; Allocating size of 4
		mov eax, 4
				call __malloc
					mov ebx, __class_J1_typecheck_constructor_invocation
		mov [eax], ebx
		...
		call __constructor__J1_typecheck_constructor_invocation__J1_typecheck_constructor_invocation$int$java_lang_String$
		add esp, 8
		pop eax

		;; ---end of new [J1_typecheck_constructor_invocation] ()
		mov eax, 123
		jmp _method_return___STATIC_method__J1_typecheck_constructor_invocation__test

		_method_return___STATIC_method__J1_typecheck_constructor_invocation__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_typecheck_constructor_invocation__J1_typecheck_constructor_invocation$int$java_lang_String$
	__constructor__J1_typecheck_constructor_invocation__J1_typecheck_constructor_invocation$int$java_lang_String$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 16]
		push eax
