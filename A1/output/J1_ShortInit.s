...
section .data
	...
	global __class_J1_ShortInit
__class_J1_ShortInit:
		global __ref_SIT_J1_ShortInit
	__ref_SIT_J1_ShortInit:
		dd 0

		global __ref_PARENTS_J1_ShortInit
	__ref_PARENTS_J1_ShortInit:
	...
	; Methods	
		...
		dd __STATIC_method__J1_ShortInit__test
...
mov ebx, __ref_SIT_J1_ShortInit
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_ShortInit__test
	__STATIC_method__J1_ShortInit__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_ShortInit__test

		_method_return___STATIC_method__J1_ShortInit__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_ShortInit__J1_ShortInit
	__constructor__J1_ShortInit__J1_ShortInit:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
