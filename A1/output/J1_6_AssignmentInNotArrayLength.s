...
section .data
	...
	global __class_J1_6_AssignmentInNotArrayLength
__class_J1_6_AssignmentInNotArrayLength:
		global __ref_SIT_J1_6_AssignmentInNotArrayLength
	__ref_SIT_J1_6_AssignmentInNotArrayLength:
		dd 0

		global __ref_PARENTS_J1_6_AssignmentInNotArrayLength
	__ref_PARENTS_J1_6_AssignmentInNotArrayLength:
	...
	; Methods	
		...
		dd __STATIC_method__J1_6_AssignmentInNotArrayLength__test
...
mov ebx, __ref_SIT_J1_6_AssignmentInNotArrayLength
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_6_AssignmentInNotArrayLength__test
	__STATIC_method__J1_6_AssignmentInNotArrayLength__test:
		push ebp
		mov ebp, esp
		...
		push eax
			;; ---new [J1_6_AssignmentInNotArrayLength] ()
			;; Allocating size of 8
			mov eax, 8
						call __malloc
							mov ebx, __class_J1_6_AssignmentInNotArrayLength
			mov [eax], ebx
			...
			;; Pushing args:
			call __constructor__J1_6_AssignmentInNotArrayLength__J1_6_AssignmentInNotArrayLength
			add esp, 0
			pop eax

			;; ---end of new [J1_6_AssignmentInNotArrayLength] ()
		pop ebx
		mov [ebx], eax

		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J1_6_AssignmentInNotArrayLength__test

		_method_return___STATIC_method__J1_6_AssignmentInNotArrayLength__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_6_AssignmentInNotArrayLength__J1_6_AssignmentInNotArrayLength
	__constructor__J1_6_AssignmentInNotArrayLength__J1_6_AssignmentInNotArrayLength:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
