...
section .data
	...
	global __class_J1_BigByteInit
__class_J1_BigByteInit:
		global __ref_SIT_J1_BigByteInit
	__ref_SIT_J1_BigByteInit:
		dd 0

		global __ref_PARENTS_J1_BigByteInit
	__ref_PARENTS_J1_BigByteInit:
	...
	; Methods	
		...
		dd __STATIC_method__J1_BigByteInit__test
...
mov ebx, __ref_SIT_J1_BigByteInit
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_BigByteInit__test
	__STATIC_method__J1_BigByteInit__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_BigByteInit__test

		_method_return___STATIC_method__J1_BigByteInit__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_BigByteInit__J1_BigByteInit
	__constructor__J1_BigByteInit__J1_BigByteInit:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
