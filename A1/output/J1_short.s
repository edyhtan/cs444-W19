...
section .data
	...
	global __class_J1_short
__class_J1_short:
		global __ref_SIT_J1_short
	__ref_SIT_J1_short:
		dd 0

		global __ref_PARENTS_J1_short
	__ref_PARENTS_J1_short:
	...
	; Methods	
		...
		dd __STATIC_method__J1_short__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_short__test
	__STATIC_method__J1_short__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args:
		call __constructor__J1_short__J1_short
		add esp, 0
		pop eax
		...
		mov eax, [eax]
				...
				jmp _method_return___STATIC_method__J1_short__test

		_method_return___STATIC_method__J1_short__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_short__J1_short
	__constructor__J1_short__J1_short:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
