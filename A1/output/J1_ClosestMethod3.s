...
section .data
	...
	global __class_J1_ClosestMethod3
__class_J1_ClosestMethod3:
		global __ref_SIT_J1_ClosestMethod3
	__ref_SIT_J1_ClosestMethod3:
		dd 0

		global __ref_PARENTS_J1_ClosestMethod3
	__ref_PARENTS_J1_ClosestMethod3:
	...
	; Methods	
		...
		dd __STATIC_method__J1_ClosestMethod3__test
		dd __method__J1_ClosestMethod3__a$java_lang_String$java_lang_String$
		dd __method__J1_ClosestMethod3__a$java_lang_String$java_lang_Object$
...
;; -----Methods-----
		global __method__J1_ClosestMethod3__a$java_lang_String$java_lang_String$
	__method__J1_ClosestMethod3__a$java_lang_String$java_lang_String$:
		push ebp
		mov ebp, esp
		...
		call __method__J1_ClosestMethod3__a$java_lang_String$java_lang_String$

		add esp, 12

		_method_return___method__J1_ClosestMethod3__a$java_lang_String$java_lang_String$:
			mov esp, ebp
			pop ebp
			ret

		global __method__J1_ClosestMethod3__a$java_lang_String$java_lang_Object$
	__method__J1_ClosestMethod3__a$java_lang_String$java_lang_Object$:
		push ebp
		mov ebp, esp

		
		_method_return___method__J1_ClosestMethod3__a$java_lang_String$java_lang_Object$:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_ClosestMethod3
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_ClosestMethod3__test
	__STATIC_method__J1_ClosestMethod3__test:
		push ebp
		mov ebp, esp

				mov eax, 123
		jmp _method_return___STATIC_method__J1_ClosestMethod3__test

		_method_return___STATIC_method__J1_ClosestMethod3__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_ClosestMethod3__J1_ClosestMethod3
	__constructor__J1_ClosestMethod3__J1_ClosestMethod3:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
