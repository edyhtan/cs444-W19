...
section .data
	...
	global __class_J1_forwardfield2
__class_J1_forwardfield2:
		global __ref_SIT_J1_forwardfield2
	__ref_SIT_J1_forwardfield2:
		dd 0

		global __ref_PARENTS_J1_forwardfield2
	__ref_PARENTS_J1_forwardfield2:
	...
	; Methods	
		...
		dd __STATIC_method__J1_forwardfield2__test
...
mov ebx, __ref_SIT_J1_forwardfield2
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_forwardfield2__test
	__STATIC_method__J1_forwardfield2__test:
		push ebp
		mov ebp, esp

		;; field access
		;; ---new [J1_forwardfield2] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_forwardfield2
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_forwardfield2__J1_forwardfield2
		add esp, 0
		pop eax

		;; ---end of new [J1_forwardfield2] ()
		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J1_forwardfield2__test

		_method_return___STATIC_method__J1_forwardfield2__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_forwardfield2__J1_forwardfield2
	__constructor__J1_forwardfield2__J1_forwardfield2:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
