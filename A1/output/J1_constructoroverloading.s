...
section .data
	...
	global __class_J1_constructoroverloading
__class_J1_constructoroverloading:
		global __ref_SIT_J1_constructoroverloading
	__ref_SIT_J1_constructoroverloading:
		dd 0

		global __ref_PARENTS_J1_constructoroverloading
	__ref_PARENTS_J1_constructoroverloading:
	...
	; Methods	
		...
		dd __STATIC_method__J1_constructoroverloading__test
...
mov ebx, __ref_SIT_J1_constructoroverloading
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_constructoroverloading__test
	__STATIC_method__J1_constructoroverloading__test:
		push ebp
		mov ebp, esp

		;; ---declare obj1
		;; ---new [J1_constructoroverloading] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_constructoroverloading
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_constructoroverloading__J1_constructoroverloading
		add esp, 0
		pop eax

		;; ---end of new [J1_constructoroverloading] ()
		...
		call __constructor__J1_constructoroverloading__J1_constructoroverloading$int$
		add esp, 4
		pop eax
		...
		jmp _method_return___STATIC_method__J1_constructoroverloading__test

		_method_return___STATIC_method__J1_constructoroverloading__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_constructoroverloading__J1_constructoroverloading
	__constructor__J1_constructoroverloading__J1_constructoroverloading:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
...
;; Epilogue
		...
		pop ebp
		ret
		global __constructor__J1_constructoroverloading__J1_constructoroverloading$int$
	__constructor__J1_constructoroverloading__J1_constructoroverloading$int$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
