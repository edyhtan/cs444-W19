...
section .data
	...
	global __class_J1_backwardRef
__class_J1_backwardRef:
		global __ref_SIT_J1_backwardRef
	__ref_SIT_J1_backwardRef:
		dd 0

		global __ref_PARENTS_J1_backwardRef
	__ref_PARENTS_J1_backwardRef:
	...
	; Methods	
		...
		dd __STATIC_method__J1_backwardRef__test
...
mov ebx, __ref_SIT_J1_backwardRef
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_backwardRef__test
	__STATIC_method__J1_backwardRef__test:
		push ebp
		mov ebp, esp
		...
		mov eax, 12
				call __malloc
					mov ebx, __class_J1_backwardRef
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_backwardRef__J1_backwardRef
		add esp, 0
		pop eax

		;; ---end of new [J1_backwardRef] ()
		mov eax, [eax+8]
		jmp _method_return___STATIC_method__J1_backwardRef__test

		_method_return___STATIC_method__J1_backwardRef__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_backwardRef__J1_backwardRef
	__constructor__J1_backwardRef__J1_backwardRef:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
