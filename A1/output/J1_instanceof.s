...
section .data
	...
	global __class_J1_instanceof
__class_J1_instanceof:
		global __ref_SIT_J1_instanceof
	__ref_SIT_J1_instanceof:
		dd 0

		global __ref_PARENTS_J1_instanceof
	__ref_PARENTS_J1_instanceof:
	...
	; Methods	
		...
		dd __STATIC_method__J1_instanceof__test
...
mov ebx, __ref_SIT_J1_instanceof
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_instanceof__test
	__STATIC_method__J1_instanceof__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args:
		call __constructor__J1_instanceof__J1_instanceof
		add esp, 0
		pop eax

		;; ---end of new [J1_instanceof] ()
		mov eax, [eax]
		mov eax, [eax+4]
		shr eax, 15
		and eax, 0x1
		...
		;; Pushing args:
		call __constructor__java_lang_String__String
		add esp, 0
		pop eax
		...
		;thenClause ...
			mov eax, 123
			jmp _method_return___STATIC_method__J1_instanceof__test
		...
		_method_return___STATIC_method__J1_instanceof__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_instanceof__J1_instanceof
	__constructor__J1_instanceof__J1_instanceof:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
