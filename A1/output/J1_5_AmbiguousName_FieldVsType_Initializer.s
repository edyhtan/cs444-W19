...
section .data
	...
	global __class_J1_5_AmbiguousName_FieldVsType_Initializer
__class_J1_5_AmbiguousName_FieldVsType_Initializer:
		global __ref_SIT_J1_5_AmbiguousName_FieldVsType_Initializer
	__ref_SIT_J1_5_AmbiguousName_FieldVsType_Initializer:
		dd 0

		global __ref_PARENTS_J1_5_AmbiguousName_FieldVsType_Initializer
	__ref_PARENTS_J1_5_AmbiguousName_FieldVsType_Initializer:
	...
	; Methods	
		...
		dd __STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__test
		dd __STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__intValue
...
;; -----Methods-----
		global __STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__intValue
	__STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__intValue:
		push ebp
		mov ebp, esp

		mov eax, 42
		jmp _method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__intValue

		_method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__intValue:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_5_AmbiguousName_FieldVsType_Initializer
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__test
	__STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__test:
		push ebp
		mov ebp, esp

		;; ---declare j
		;; ---new [J1_5_AmbiguousName_FieldVsType_Initializer] ()
		;; Allocating size of 12
		mov eax, 12
				call __malloc
					mov ebx, __class_J1_5_AmbiguousName_FieldVsType_Initializer
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_5_AmbiguousName_FieldVsType_Initializer__J1_5_AmbiguousName_FieldVsType_Initializer
		add esp, 0
		pop eax

		;; ---end of new [J1_5_AmbiguousName_FieldVsType_Initializer] ()
		...
		jmp _method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__test

		_method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType_Initializer__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_5_AmbiguousName_FieldVsType_Initializer__J1_5_AmbiguousName_FieldVsType_Initializer
	__constructor__J1_5_AmbiguousName_FieldVsType_Initializer__J1_5_AmbiguousName_FieldVsType_Initializer:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
...
;; Field init, push object to stack
		mov eax, [ebp + 8]
		push eax
;; Field init:: J1_5_AmbiguousName_FieldVsType_Initializer
...
;; Field init:: field
				...
				;; Names(ArgList)
					;; Implicit This
					mov eax, [ebp + 8]
					;; Field J1_5_AmbiguousName_FieldVsType_Initializer
					add eax, 4
					mov eax, [eax]
