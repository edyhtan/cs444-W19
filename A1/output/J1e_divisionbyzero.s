...
extern __exception
extern __malloc
extern __method__java_io_PrintStream__println$int$
...
section .data
	...
	global __class_J1e_divisionbyzero
__class_J1e_divisionbyzero:
		global __ref_SIT_J1e_divisionbyzero
	__ref_SIT_J1e_divisionbyzero:
		dd 0

		global __ref_PARENTS_J1e_divisionbyzero
	__ref_PARENTS_J1e_divisionbyzero:
	...
	; Methods	
		...
		dd __STATIC_method__J1e_divisionbyzero__test
...
mov ebx, __ref_SIT_J1e_divisionbyzero
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1e_divisionbyzero__test
	__STATIC_method__J1e_divisionbyzero__test:
		push ebp
		mov ebp, esp
		...
		call __method__java_io_PrintStream__println$int$

		add esp, 8
		mov eax, 123
		jmp _method_return___STATIC_method__J1e_divisionbyzero__test

		_method_return___STATIC_method__J1e_divisionbyzero__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1e_divisionbyzero__J1e_divisionbyzero
	__constructor__J1e_divisionbyzero__J1e_divisionbyzero:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
