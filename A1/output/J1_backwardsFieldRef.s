...
section .data
	...
	global __class_J1_backwardsFieldRef
__class_J1_backwardsFieldRef:
		global __ref_SIT_J1_backwardsFieldRef
	__ref_SIT_J1_backwardsFieldRef:
		dd 0

		global __ref_PARENTS_J1_backwardsFieldRef
	__ref_PARENTS_J1_backwardsFieldRef:
	...
	; Methods	
		...
		dd __STATIC_method__J1_backwardsFieldRef__test
...
mov ebx, __ref_SIT_J1_backwardsFieldRef
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_backwardsFieldRef__test
	__STATIC_method__J1_backwardsFieldRef__test:
		push ebp
		mov ebp, esp

		;; ---declare b
		;; ---new [J1_backwardsFieldRef] ()
		;; Allocating size of 12
		mov eax, 12
				call __malloc
					mov ebx, __class_J1_backwardsFieldRef
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_backwardsFieldRef__J1_backwardsFieldRef
		add esp, 0
		pop eax

		;; ---end of new [J1_backwardsFieldRef] ()
		...
		jmp _method_return___STATIC_method__J1_backwardsFieldRef__test

		_method_return___STATIC_method__J1_backwardsFieldRef__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_backwardsFieldRef__J1_backwardsFieldRef
	__constructor__J1_backwardsFieldRef__J1_backwardsFieldRef:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
