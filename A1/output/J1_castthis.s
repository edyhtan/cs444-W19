...
section .data
	...
	global __class_J1_castthis
__class_J1_castthis:
		global __ref_SIT_J1_castthis
	__ref_SIT_J1_castthis:
		dd 0

		global __ref_PARENTS_J1_castthis
	__ref_PARENTS_J1_castthis:
	...
	; Methods	
		...
		dd __STATIC_method__J1_castthis__test
		dd __method__J1_castthis__m
...
;; -----Methods-----
		global __method__J1_castthis__m
	__method__J1_castthis__m:
		push ebp
		mov ebp, esp
		...
		_method_return___method__J1_castthis__m:
			mov esp, ebp
			pop ebp
			ret
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_castthis__test
	__STATIC_method__J1_castthis__test:
		push ebp
		mov ebp, esp
		...
		;; o.code
			...
			;; Pushing args:
			call __constructor__J1_castthis__J1_castthis
			add esp, 0
			pop eax
		...
		push eax
		;; Pushing args
		call __method__J1_castthis__m

		add esp, 4
		mov eax, 123
		jmp _method_return___STATIC_method__J1_castthis__test

		_method_return___STATIC_method__J1_castthis__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_castthis__J1_castthis
	__constructor__J1_castthis__J1_castthis:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
