...
section .data
	...
	global __class_J1_5_AmbiguousName_LocalVsType
__class_J1_5_AmbiguousName_LocalVsType:
		global __ref_SIT_J1_5_AmbiguousName_LocalVsType
	__ref_SIT_J1_5_AmbiguousName_LocalVsType:
		dd 0

		global __ref_PARENTS_J1_5_AmbiguousName_LocalVsType
	__ref_PARENTS_J1_5_AmbiguousName_LocalVsType:
	...
	; Methods	
		...
		dd __STATIC_method__J1_5_AmbiguousName_LocalVsType__test
...
mov ebx, __ref_SIT_J1_5_AmbiguousName_LocalVsType
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_5_AmbiguousName_LocalVsType__test
	__STATIC_method__J1_5_AmbiguousName_LocalVsType__test:
		push ebp
		mov ebp, esp

		;; ---declare J1_5_AmbiguousName_LocalVsType
		;; ---new [J1_5_AmbiguousName_LocalVsType] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_5_AmbiguousName_LocalVsType
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_5_AmbiguousName_LocalVsType__J1_5_AmbiguousName_LocalVsType
		add esp, 0
		pop eax

		;; ---end of new [J1_5_AmbiguousName_LocalVsType] ()

		push eax
		;; ---end of declare J1_5_AmbiguousName_LocalVsType

					;; Local Var J1_5_AmbiguousName_LocalVsType
			mov eax, ebp
			sub eax, 4
			mov eax, [eax]
		...
		jmp _method_return___STATIC_method__J1_5_AmbiguousName_LocalVsType__test

		_method_return___STATIC_method__J1_5_AmbiguousName_LocalVsType__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_5_AmbiguousName_LocalVsType__J1_5_AmbiguousName_LocalVsType
	__constructor__J1_5_AmbiguousName_LocalVsType__J1_5_AmbiguousName_LocalVsType:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
