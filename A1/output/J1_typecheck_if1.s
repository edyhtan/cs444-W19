...
section .data
	...
	global __class_J1_typecheck_if1
__class_J1_typecheck_if1:
		global __ref_SIT_J1_typecheck_if1
	__ref_SIT_J1_typecheck_if1:
		dd 0

		global __ref_PARENTS_J1_typecheck_if1
	__ref_PARENTS_J1_typecheck_if1:
	...
	; Methods	
		...
		dd __STATIC_method__J1_typecheck_if1__test
...
mov ebx, __ref_SIT_J1_typecheck_if1
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_typecheck_if1__test
	__STATIC_method__J1_typecheck_if1__test:
		push ebp
		mov ebp, esp
		...
		;thenClause ...
			mov eax, 123
			jmp _method_return___STATIC_method__J1_typecheck_if1__test
		...
		_method_return___STATIC_method__J1_typecheck_if1__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_typecheck_if1__J1_typecheck_if1
	__constructor__J1_typecheck_if1__J1_typecheck_if1:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
