...
section .data
	...
	global __class_J1_fieldInOwnInit
__class_J1_fieldInOwnInit:
		global __ref_SIT_J1_fieldInOwnInit
	__ref_SIT_J1_fieldInOwnInit:
		dd 0

		global __ref_PARENTS_J1_fieldInOwnInit
	__ref_PARENTS_J1_fieldInOwnInit:
	...
	; Methods	
		...
		dd __STATIC_method__J1_fieldInOwnInit__test
...
mov ebx, __ref_SIT_J1_fieldInOwnInit
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_fieldInOwnInit__test
	__STATIC_method__J1_fieldInOwnInit__test:
		push ebp
		mov ebp, esp

		;; field access
		;; ---new [J1_fieldInOwnInit] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_fieldInOwnInit
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_fieldInOwnInit__J1_fieldInOwnInit
		add esp, 0
		pop eax

		;; ---end of new [J1_fieldInOwnInit] ()
		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J1_fieldInOwnInit__test

		_method_return___STATIC_method__J1_fieldInOwnInit__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_fieldInOwnInit__J1_fieldInOwnInit
	__constructor__J1_fieldInOwnInit__J1_fieldInOwnInit:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
