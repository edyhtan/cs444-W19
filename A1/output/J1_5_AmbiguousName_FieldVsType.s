...
section .data
	...
	global __class_J1_5_AmbiguousName_FieldVsType
__class_J1_5_AmbiguousName_FieldVsType:
		global __ref_SIT_J1_5_AmbiguousName_FieldVsType
	__ref_SIT_J1_5_AmbiguousName_FieldVsType:
		dd 0

		global __ref_PARENTS_J1_5_AmbiguousName_FieldVsType
	__ref_PARENTS_J1_5_AmbiguousName_FieldVsType:
	...
	; Methods	
		...
		dd __method__J1_5_AmbiguousName_FieldVsType__method
		dd __STATIC_method__J1_5_AmbiguousName_FieldVsType__test
		dd __STATIC_method__J1_5_AmbiguousName_FieldVsType__intValue
...
;; -----Methods-----
		global __method__J1_5_AmbiguousName_FieldVsType__method
	__method__J1_5_AmbiguousName_FieldVsType__method:
		push ebp
		mov ebp, esp
		...
		;; Names(ArgList)
			;; Implicit This
			mov eax, [ebp + 8]
			;; Field J1_5_AmbiguousName_FieldVsType
			add eax, 4
			mov eax, [eax]
		...
		jmp _method_return___method__J1_5_AmbiguousName_FieldVsType__method

		_method_return___method__J1_5_AmbiguousName_FieldVsType__method:
			mov esp, ebp
			pop ebp
			ret

		global __STATIC_method__J1_5_AmbiguousName_FieldVsType__intValue
	__STATIC_method__J1_5_AmbiguousName_FieldVsType__intValue:
		push ebp
		mov ebp, esp

		mov eax, 42
		jmp _method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType__intValue

		_method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType__intValue:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_5_AmbiguousName_FieldVsType
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_5_AmbiguousName_FieldVsType__test
	__STATIC_method__J1_5_AmbiguousName_FieldVsType__test:
		push ebp
		mov ebp, esp

		;; ---declare j
		;; ---new [J1_5_AmbiguousName_FieldVsType] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_5_AmbiguousName_FieldVsType
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_5_AmbiguousName_FieldVsType__J1_5_AmbiguousName_FieldVsType
		add esp, 0
		pop eax

		;; ---end of new [J1_5_AmbiguousName_FieldVsType] ()
		...
		;; ---End of method invocation
		jmp _method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType__test

		_method_return___STATIC_method__J1_5_AmbiguousName_FieldVsType__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_5_AmbiguousName_FieldVsType__J1_5_AmbiguousName_FieldVsType
	__constructor__J1_5_AmbiguousName_FieldVsType__J1_5_AmbiguousName_FieldVsType:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
...
;; Field init, push object to stack
		mov eax, [ebp + 8]
		push eax
;; Field init:: J1_5_AmbiguousName_FieldVsType
