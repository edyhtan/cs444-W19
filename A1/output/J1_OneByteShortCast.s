...
section .data
	...
	global __class_J1_OneByteShortCast
__class_J1_OneByteShortCast:
		global __ref_SIT_J1_OneByteShortCast
	__ref_SIT_J1_OneByteShortCast:
		dd 0

		global __ref_PARENTS_J1_OneByteShortCast
	__ref_PARENTS_J1_OneByteShortCast:
	...
	; Methods	
		...
		dd __STATIC_method__J1_OneByteShortCast__test
...
mov ebx, __ref_SIT_J1_OneByteShortCast
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_OneByteShortCast__test
	__STATIC_method__J1_OneByteShortCast__test:
		push ebp
		mov ebp, esp

				jmp _method_return___STATIC_method__J1_OneByteShortCast__test

		_method_return___STATIC_method__J1_OneByteShortCast__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_OneByteShortCast__J1_OneByteShortCast
	__constructor__J1_OneByteShortCast__J1_OneByteShortCast:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
