...
section .data
	...
	global __class_J1_length_field_not_array
__class_J1_length_field_not_array:
		global __ref_SIT_J1_length_field_not_array
	__ref_SIT_J1_length_field_not_array:
		dd 0

		global __ref_PARENTS_J1_length_field_not_array
	__ref_PARENTS_J1_length_field_not_array:
	...
	; Methods	
		...
		dd __STATIC_method__J1_length_field_not_array__test
...
mov ebx, __ref_SIT_J1_length_field_not_array
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_length_field_not_array__test
	__STATIC_method__J1_length_field_not_array__test:
		push ebp
		mov ebp, esp

		;; ---declare tmp
		;; ---new [J1_length_field_not_array] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_length_field_not_array
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_length_field_not_array__J1_length_field_not_array
		add esp, 0
		pop eax

		;; ---end of new [J1_length_field_not_array] ()
		...
		jmp _method_return___STATIC_method__J1_length_field_not_array__test

		_method_return___STATIC_method__J1_length_field_not_array__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_length_field_not_array__J1_length_field_not_array
	__constructor__J1_length_field_not_array__J1_length_field_not_array:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
