...
section .data
	...
	global __class_J1_methodWithArgList
__class_J1_methodWithArgList:
		global __ref_SIT_J1_methodWithArgList
	__ref_SIT_J1_methodWithArgList:
		dd 0

		global __ref_PARENTS_J1_methodWithArgList
	__ref_PARENTS_J1_methodWithArgList:
	...
	; Methods	
		...
		dd __STATIC_method__J1_methodWithArgList__test
		dd __method__J1_methodWithArgList__foo$int$java_lang_String$J1_methodWithArgList$
...
;; -----Methods-----
		global __method__J1_methodWithArgList__foo$int$java_lang_String$J1_methodWithArgList$
	__method__J1_methodWithArgList__foo$int$java_lang_String$J1_methodWithArgList$:
		push ebp
		mov ebp, esp
		...
		;thenClause ...
			...
			jmp _method_return___method__J1_methodWithArgList__foo$int$java_lang_String$J1_methodWithArgList$
		...
		_method_return___method__J1_methodWithArgList__foo$int$java_lang_String$J1_methodWithArgList$:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_methodWithArgList
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_methodWithArgList__test
	__STATIC_method__J1_methodWithArgList__test:
		push ebp
		mov ebp, esp

		;; ---declare j
		;; ---new [J1_methodWithArgList] ()
		;; Allocating size of 4
		mov eax, 4
				call __malloc
					mov ebx, __class_J1_methodWithArgList
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_methodWithArgList__J1_methodWithArgList
		add esp, 0
		pop eax

		;; ---end of new [J1_methodWithArgList] ()
		...
		jmp _method_return___STATIC_method__J1_methodWithArgList__test

		_method_return___STATIC_method__J1_methodWithArgList__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_methodWithArgList__J1_methodWithArgList
	__constructor__J1_methodWithArgList__J1_methodWithArgList:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
