...
section .data
	...
	global __class_J1_castMultiple
__class_J1_castMultiple:
		global __ref_SIT_J1_castMultiple
	__ref_SIT_J1_castMultiple:
		dd 0

		global __ref_PARENTS_J1_castMultiple
	__ref_PARENTS_J1_castMultiple:
	...
	; Methods	
		...
		dd __STATIC_method__J1_castMultiple__test
...
mov ebx, __ref_SIT_J1_castMultiple
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_castMultiple__test
	__STATIC_method__J1_castMultiple__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_castMultiple__test

		_method_return___STATIC_method__J1_castMultiple__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_castMultiple__J1_castMultiple
	__constructor__J1_castMultiple__J1_castMultiple:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
