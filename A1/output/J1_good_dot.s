...
section .data
	...
	global __class_J1_good_dot
__class_J1_good_dot:
		global __ref_SIT_J1_good_dot
	__ref_SIT_J1_good_dot:
		dd 0

		global __ref_PARENTS_J1_good_dot
	__ref_PARENTS_J1_good_dot:
	...
	; Methods	
		...
		dd __STATIC_method__J1_good_dot__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_good_dot__test
	__STATIC_method__J1_good_dot__test:
		push ebp
		mov ebp, esp
		...
		push eax
		;; Pushing args
		call __method__java_io_OutputStream__flush

		add esp, 4
		mov eax, 123
		jmp _method_return___STATIC_method__J1_good_dot__test

		_method_return___STATIC_method__J1_good_dot__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_good_dot__J1_good_dot
	__constructor__J1_good_dot__J1_good_dot:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
