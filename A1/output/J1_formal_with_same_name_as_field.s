...
section .data
	...
	global __class_J1_formal_with_same_name_as_field
__class_J1_formal_with_same_name_as_field:
		global __ref_SIT_J1_formal_with_same_name_as_field
	__ref_SIT_J1_formal_with_same_name_as_field:
		dd 0

		global __ref_PARENTS_J1_formal_with_same_name_as_field
	__ref_PARENTS_J1_formal_with_same_name_as_field:
	...
	; Methods	
		...
		dd __STATIC_method__J1_formal_with_same_name_as_field__test
		dd __method__J1_formal_with_same_name_as_field__testerMethod$java_lang_String$
...
;; -----Methods-----
		global __method__J1_formal_with_same_name_as_field__testerMethod$java_lang_String$
	__method__J1_formal_with_same_name_as_field__testerMethod$java_lang_String$:
		push ebp
		mov ebp, esp

		mov eax, 123
		jmp _method_return___method__J1_formal_with_same_name_as_field__testerMethod$java_lang_String$

		_method_return___method__J1_formal_with_same_name_as_field__testerMethod$java_lang_String$:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_formal_with_same_name_as_field
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_formal_with_same_name_as_field__test
	__STATIC_method__J1_formal_with_same_name_as_field__test:
		push ebp
		mov ebp, esp

		;; ---declare j
		;; ---new [J1_formal_with_same_name_as_field] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_formal_with_same_name_as_field
		mov [eax], ebx
		...
		call __constructor__J1_formal_with_same_name_as_field__J1_formal_with_same_name_as_field$java_lang_String$
		add esp, 4
		pop eax

		;; ---end of new [J1_formal_with_same_name_as_field] ()
		...
		jmp _method_return___STATIC_method__J1_formal_with_same_name_as_field__test

		_method_return___STATIC_method__J1_formal_with_same_name_as_field__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_formal_with_same_name_as_field__J1_formal_with_same_name_as_field$java_lang_String$
	__constructor__J1_formal_with_same_name_as_field__J1_formal_with_same_name_as_field$java_lang_String$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
