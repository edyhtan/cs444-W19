...
section .data
	...
	global __class_J1_instanceof_array
__class_J1_instanceof_array:
		global __ref_SIT_J1_instanceof_array
	__ref_SIT_J1_instanceof_array:
		dd 0

		global __ref_PARENTS_J1_instanceof_array
	__ref_PARENTS_J1_instanceof_array:
	...
	; Methods	
		...
		dd __method__J1_instanceof_array__foo$java_lang_Object$
		dd __STATIC_method__J1_instanceof_array__test
...
mov ebx, __ref_SIT_J1_instanceof_array
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_instanceof_array__test
	__STATIC_method__J1_instanceof_array__test:
		push ebp
		mov ebp, esp

		mov eax, 123
		jmp _method_return___STATIC_method__J1_instanceof_array__test

		_method_return___STATIC_method__J1_instanceof_array__test:
			mov esp, ebp
			pop ebp
			ret

		global __method__J1_instanceof_array__foo$java_lang_Object$
	__method__J1_instanceof_array__foo$java_lang_Object$:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___method__J1_instanceof_array__foo$java_lang_Object$

		_method_return___method__J1_instanceof_array__foo$java_lang_Object$:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_instanceof_array__J1_instanceof_array
	__constructor__J1_instanceof_array__J1_instanceof_array:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
