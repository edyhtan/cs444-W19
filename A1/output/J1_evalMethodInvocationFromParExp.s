...
section .data
	...
	global __class_J1_evalMethodInvocationFromParExp
__class_J1_evalMethodInvocationFromParExp:
		global __ref_SIT_J1_evalMethodInvocationFromParExp
	__ref_SIT_J1_evalMethodInvocationFromParExp:
		dd 0

		global __ref_PARENTS_J1_evalMethodInvocationFromParExp
	__ref_PARENTS_J1_evalMethodInvocationFromParExp:
	...
	; Methods	
		...
		dd __STATIC_method__J1_evalMethodInvocationFromParExp__test
...
mov ebx, __ref_SIT_J1_evalMethodInvocationFromParExp
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_evalMethodInvocationFromParExp__test
	__STATIC_method__J1_evalMethodInvocationFromParExp__test:
		push ebp
		mov ebp, esp
		...
		;; o.code
			...
			call __constructor__java_lang_Integer__Integer$java_lang_String$
			add esp, 4
			pop eax
		...
		add esp, 4
		jmp _method_return___STATIC_method__J1_evalMethodInvocationFromParExp__test

		_method_return___STATIC_method__J1_evalMethodInvocationFromParExp__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_evalMethodInvocationFromParExp__J1_evalMethodInvocationFromParExp
	__constructor__J1_evalMethodInvocationFromParExp__J1_evalMethodInvocationFromParExp:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
