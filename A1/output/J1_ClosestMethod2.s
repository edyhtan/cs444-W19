...
section .data
	...
	global __class_J1_ClosestMethod2
__class_J1_ClosestMethod2:
		global __ref_SIT_J1_ClosestMethod2
	__ref_SIT_J1_ClosestMethod2:
		dd 0

		global __ref_PARENTS_J1_ClosestMethod2
	__ref_PARENTS_J1_ClosestMethod2:
	...
	; Methods	
		...
		dd __STATIC_method__J1_ClosestMethod2__test
		dd __method__J1_ClosestMethod2__a$short$
		dd __method__J1_ClosestMethod2__a$int$
...
;; -----Methods-----
		global __method__J1_ClosestMethod2__a$short$
	__method__J1_ClosestMethod2__a$short$:
		push ebp
		mov ebp, esp
		...
		call __method__J1_ClosestMethod2__a$short$

		add esp, 8

		_method_return___method__J1_ClosestMethod2__a$short$:
			mov esp, ebp
			pop ebp
			ret

		global __method__J1_ClosestMethod2__a$int$
	__method__J1_ClosestMethod2__a$int$:
		push ebp
		mov ebp, esp

		
		_method_return___method__J1_ClosestMethod2__a$int$:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_ClosestMethod2
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_ClosestMethod2__test
	__STATIC_method__J1_ClosestMethod2__test:
		push ebp
		mov ebp, esp

				mov eax, 123
		jmp _method_return___STATIC_method__J1_ClosestMethod2__test

		_method_return___STATIC_method__J1_ClosestMethod2__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_ClosestMethod2__J1_ClosestMethod2
	__constructor__J1_ClosestMethod2__J1_ClosestMethod2:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
