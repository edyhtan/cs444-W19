...
section .data
	...
	global __class_J1_typecheck_expstm
__class_J1_typecheck_expstm:
		global __ref_SIT_J1_typecheck_expstm
	__ref_SIT_J1_typecheck_expstm:
		dd 0

		global __ref_PARENTS_J1_typecheck_expstm
	__ref_PARENTS_J1_typecheck_expstm:
	...
	; Methods	
		...
		dd __STATIC_method__J1_typecheck_expstm__test
...
mov ebx, __ref_SIT_J1_typecheck_expstm
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_typecheck_expstm__test
	__STATIC_method__J1_typecheck_expstm__test:
		push ebp
		mov ebp, esp
		...
		add esp, 4
		mov eax, 123
		jmp _method_return___STATIC_method__J1_typecheck_expstm__test

		_method_return___STATIC_method__J1_typecheck_expstm__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_typecheck_expstm__J1_typecheck_expstm
	__constructor__J1_typecheck_expstm__J1_typecheck_expstm:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
