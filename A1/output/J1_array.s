...
section .data
	...
	global __class_J1_array
__class_J1_array:
		global __ref_SIT_J1_array
	__ref_SIT_J1_array:
		dd 0

		global __ref_PARENTS_J1_array
	__ref_PARENTS_J1_array:
	...
	; Methods	
		...
		dd __STATIC_method__J1_array__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_array__test
	__STATIC_method__J1_array__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args:
		call __constructor__J1_array__J1_array
		add esp, 0
		pop eax
		...
		jmp _method_return___STATIC_method__J1_array__test

		_method_return___STATIC_method__J1_array__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_array__J1_array
	__constructor__J1_array__J1_array:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
