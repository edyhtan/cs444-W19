...
extern __field_J2_fieldinit_forward_ref_i
extern __method__java_lang_Object__hashCode
extern __field_J2_fieldinit_forward_ref_j
...
section .data
	...
	global __class_J2_fieldinit_forward_ref
__class_J2_fieldinit_forward_ref:
		global __ref_SIT_J2_fieldinit_forward_ref
	__ref_SIT_J2_fieldinit_forward_ref:
		dd 0

		global __ref_PARENTS_J2_fieldinit_forward_ref
	__ref_PARENTS_J2_fieldinit_forward_ref:
	...
	; Methods	
		...
		dd __STATIC_method__J2_fieldinit_forward_ref__test

;; Static fields
		global __field_J2_fieldinit_forward_ref_i
	__field_J2_fieldinit_forward_ref_i		dd 0

		global __field_J2_fieldinit_forward_ref_j
	__field_J2_fieldinit_forward_ref_j		dd 0
...
mov ebx, __ref_SIT_J2_fieldinit_forward_ref
mov [ebx], eax
...
;; Static Field: __field_J2_fieldinit_forward_ref_i
mov eax, 3
mov ebx, __field_J2_fieldinit_forward_ref_i
mov [ebx], eax

;; Static Field: __field_J2_fieldinit_forward_ref_j
mov eax, 3
mov ebx, __field_J2_fieldinit_forward_ref_j
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J2_fieldinit_forward_ref__test
	__STATIC_method__J2_fieldinit_forward_ref__test:
		push ebp
		mov ebp, esp
		...
		mov eax, __field_J2_fieldinit_forward_ref_i
		mov eax, [eax]
		...
		jmp _method_return___STATIC_method__J2_fieldinit_forward_ref__test

		_method_return___STATIC_method__J2_fieldinit_forward_ref__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J2_fieldinit_forward_ref__J2_fieldinit_forward_ref
	__constructor__J2_fieldinit_forward_ref__J2_fieldinit_forward_ref:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
...
;; Field init:: i
				...
				mov eax, __field_J2_fieldinit_forward_ref_j
				mov eax, [eax]
