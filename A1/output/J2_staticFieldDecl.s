...
extern __field_J2_staticFieldDecl_field
...
section .data
	...
	global __class_J2_staticFieldDecl
__class_J2_staticFieldDecl:
		global __ref_SIT_J2_staticFieldDecl
	__ref_SIT_J2_staticFieldDecl:
		dd 0

		global __ref_PARENTS_J2_staticFieldDecl
	__ref_PARENTS_J2_staticFieldDecl:
	...
	; Methods	
		...
		dd __STATIC_method__J2_staticFieldDecl__test

;; Static fields
		global __field_J2_staticFieldDecl_field
	__field_J2_staticFieldDecl_field		dd 0
...
mov ebx, __ref_SIT_J2_staticFieldDecl
mov [ebx], eax
...
;; Static Field: __field_J2_staticFieldDecl_field
mov eax, 3
mov ebx, __field_J2_staticFieldDecl_field
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J2_staticFieldDecl__test
	__STATIC_method__J2_staticFieldDecl__test:
		push ebp
		mov ebp, esp
		...
		mov eax, __field_J2_staticFieldDecl_field
		mov eax, [eax]
		...
		jmp _method_return___STATIC_method__J2_staticFieldDecl__test

		_method_return___STATIC_method__J2_staticFieldDecl__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J2_staticFieldDecl__J2_staticFieldDecl
	__constructor__J2_staticFieldDecl__J2_staticFieldDecl:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
