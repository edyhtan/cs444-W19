...
section .data
	...
	global __class_J1_typecheck_while
__class_J1_typecheck_while:
		global __ref_SIT_J1_typecheck_while
	__ref_SIT_J1_typecheck_while:
		dd 0

		global __ref_PARENTS_J1_typecheck_while
	__ref_PARENTS_J1_typecheck_while:
	...
	; Methods	
		...
		dd __STATIC_method__J1_typecheck_while__test
...
mov ebx, __ref_SIT_J1_typecheck_while
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_typecheck_while__test
	__STATIC_method__J1_typecheck_while__test:
		push ebp
		mov ebp, esp
		...
		.while2:
			...
			;; while statement code...
			mov eax, 123
			jmp _method_return___STATIC_method__J1_typecheck_while__test
			jmp .while2

		.endwhile2:


		_method_return___STATIC_method__J1_typecheck_while__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_typecheck_while__J1_typecheck_while
	__constructor__J1_typecheck_while__J1_typecheck_while:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
