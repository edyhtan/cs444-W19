...
section .data
	...
	global __class_J1_implicitthisformethods
__class_J1_implicitthisformethods:
		global __ref_SIT_J1_implicitthisformethods
	__ref_SIT_J1_implicitthisformethods:
		dd 0

		global __ref_PARENTS_J1_implicitthisformethods
	__ref_PARENTS_J1_implicitthisformethods:
	...
	; Methods	
		...
		dd __method__J1_implicitthisformethods__m1
		dd __STATIC_method__J1_implicitthisformethods__test
		dd __method__J1_implicitthisformethods__m2
...
;; -----Methods-----
		global __method__J1_implicitthisformethods__m1
	__method__J1_implicitthisformethods__m1:
		push ebp
		mov ebp, esp

		mov eax, 123
		jmp _method_return___method__J1_implicitthisformethods__m1

		_method_return___method__J1_implicitthisformethods__m1:
			mov esp, ebp
			pop ebp
			ret

		global __method__J1_implicitthisformethods__m2
	__method__J1_implicitthisformethods__m2:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___method__J1_implicitthisformethods__m2

		_method_return___method__J1_implicitthisformethods__m2:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_implicitthisformethods
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_implicitthisformethods__test
	__STATIC_method__J1_implicitthisformethods__test:
		push ebp
		mov ebp, esp

		;; ---Method Invocation: 
		;; Primary.id(ArgList)
			;; ---new [J1_implicitthisformethods] ()
			;; Allocating size of 4
			mov eax, 4
						call __malloc
							mov ebx, __class_J1_implicitthisformethods
			mov [eax], ebx
			...
			;; Pushing args:
			call __constructor__J1_implicitthisformethods__J1_implicitthisformethods
			add esp, 0
			pop eax

			;; ---end of new [J1_implicitthisformethods] ()
		cmp eax, 0
		je __exception
		push eax
		...
		;; ---End of method invocation
		jmp _method_return___STATIC_method__J1_implicitthisformethods__test

		_method_return___STATIC_method__J1_implicitthisformethods__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_implicitthisformethods__J1_implicitthisformethods
	__constructor__J1_implicitthisformethods__J1_implicitthisformethods:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
