...
section .data
	...
	global __class_J1_primitivecasts
__class_J1_primitivecasts:
		global __ref_SIT_J1_primitivecasts
	__ref_SIT_J1_primitivecasts:
		dd 0

		global __ref_PARENTS_J1_primitivecasts
	__ref_PARENTS_J1_primitivecasts:
	...
	; Methods	
		...
		dd __STATIC_method__J1_primitivecasts__test
...
mov ebx, __ref_SIT_J1_primitivecasts
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_primitivecasts__test
	__STATIC_method__J1_primitivecasts__test:
		push ebp
		mov ebp, esp

		;; ---declare t
		;; casting
		;; primitive run-time casting to [boolean]
				mov eax, 1
		...
		;; primitive run-time casting to [int]
				mov eax, 123
				jmp _method_return___STATIC_method__J1_primitivecasts__test

		_method_return___STATIC_method__J1_primitivecasts__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_primitivecasts__J1_primitivecasts
	__constructor__J1_primitivecasts__J1_primitivecasts:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
