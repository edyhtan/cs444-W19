...
section .data
	...
	global __class_J1_int
__class_J1_int:
		global __ref_SIT_J1_int
	__ref_SIT_J1_int:
		dd 0

		global __ref_PARENTS_J1_int
	__ref_PARENTS_J1_int:
	...
	; Methods	
		...
		dd __STATIC_method__J1_int__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_int__test
	__STATIC_method__J1_int__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args:
		call __constructor__J1_int__J1_int
		add esp, 0
		pop eax
		...
		jmp _method_return___STATIC_method__J1_int__test

		_method_return___STATIC_method__J1_int__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_int__J1_int
	__constructor__J1_int__J1_int:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
