...
section .data
	...
	global __class_J1_OneByteIntCast
__class_J1_OneByteIntCast:
		global __ref_SIT_J1_OneByteIntCast
	__ref_SIT_J1_OneByteIntCast:
		dd 0

		global __ref_PARENTS_J1_OneByteIntCast
	__ref_PARENTS_J1_OneByteIntCast:
	...
	; Methods	
		...
		dd __STATIC_method__J1_OneByteIntCast__test
...
mov ebx, __ref_SIT_J1_OneByteIntCast
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_OneByteIntCast__test
	__STATIC_method__J1_OneByteIntCast__test:
		push ebp
		mov ebp, esp

				jmp _method_return___STATIC_method__J1_OneByteIntCast__test

		_method_return___STATIC_method__J1_OneByteIntCast__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_OneByteIntCast__J1_OneByteIntCast
	__constructor__J1_OneByteIntCast__J1_OneByteIntCast:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
