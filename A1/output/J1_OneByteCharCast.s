...
section .data
	...
	global __class_J1_OneByteCharCast
__class_J1_OneByteCharCast:
		global __ref_SIT_J1_OneByteCharCast
	__ref_SIT_J1_OneByteCharCast:
		dd 0

		global __ref_PARENTS_J1_OneByteCharCast
	__ref_PARENTS_J1_OneByteCharCast:
	...
	; Methods	
		...
		dd __STATIC_method__J1_OneByteCharCast__test
...
mov ebx, __ref_SIT_J1_OneByteCharCast
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_OneByteCharCast__test
	__STATIC_method__J1_OneByteCharCast__test:
		push ebp
		mov ebp, esp
		...
		;; primitive run-time casting to [char]
				mov eax, 123
		and eax, 0xfff
		jmp _method_return___STATIC_method__J1_OneByteCharCast__test

		_method_return___STATIC_method__J1_OneByteCharCast__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_OneByteCharCast__J1_OneByteCharCast
	__constructor__J1_OneByteCharCast__J1_OneByteCharCast:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
