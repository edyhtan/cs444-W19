...
section .data
	...
	global __class_J1_ByteCast
__class_J1_ByteCast:
		global __ref_SIT_J1_ByteCast
	__ref_SIT_J1_ByteCast:
		dd 0

		global __ref_PARENTS_J1_ByteCast
	__ref_PARENTS_J1_ByteCast:
	...
	; Methods	
		...
		dd __STATIC_method__J1_ByteCast__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_ByteCast__test
	__STATIC_method__J1_ByteCast__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_ByteCast__test

		_method_return___STATIC_method__J1_ByteCast__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_ByteCast__J1_ByteCast
	__constructor__J1_ByteCast__J1_ByteCast:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
