...
section .data
	...
	global __class_J1_fieldinit_forward_ref
__class_J1_fieldinit_forward_ref:
		global __ref_SIT_J1_fieldinit_forward_ref
	__ref_SIT_J1_fieldinit_forward_ref:
		dd 0

		global __ref_PARENTS_J1_fieldinit_forward_ref
	__ref_PARENTS_J1_fieldinit_forward_ref:
	...
	; Methods	
		...
		dd __STATIC_method__J1_fieldinit_forward_ref__test
...
mov ebx, __ref_SIT_J1_fieldinit_forward_ref
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_fieldinit_forward_ref__test
	__STATIC_method__J1_fieldinit_forward_ref__test:
		push ebp
		mov ebp, esp

		;; field access
		;; ---new [J1_fieldinit_forward_ref] ()
		;; Allocating size of 12
		mov eax, 12
				call __malloc
					mov ebx, __class_J1_fieldinit_forward_ref
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_fieldinit_forward_ref__J1_fieldinit_forward_ref
		add esp, 0
		pop eax

		;; ---end of new [J1_fieldinit_forward_ref] ()
		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J1_fieldinit_forward_ref__test

		_method_return___STATIC_method__J1_fieldinit_forward_ref__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_fieldinit_forward_ref__J1_fieldinit_forward_ref
	__constructor__J1_fieldinit_forward_ref__J1_fieldinit_forward_ref:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
