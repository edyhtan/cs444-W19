...
section .data
	...
	global __class_J1_typecheck_instanceof
__class_J1_typecheck_instanceof:
		global __ref_SIT_J1_typecheck_instanceof
	__ref_SIT_J1_typecheck_instanceof:
		dd 0

		global __ref_PARENTS_J1_typecheck_instanceof
	__ref_PARENTS_J1_typecheck_instanceof:
	...
	; Methods	
		...
		dd __STATIC_method__J1_typecheck_instanceof__test
...
mov ebx, __ref_SIT_J1_typecheck_instanceof
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_typecheck_instanceof__test
	__STATIC_method__J1_typecheck_instanceof__test:
		push ebp
		mov ebp, esp
		...
		;thenClause ...
			mov eax, 123
			jmp _method_return___STATIC_method__J1_typecheck_instanceof__test
		...
		_method_return___STATIC_method__J1_typecheck_instanceof__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_typecheck_instanceof__J1_typecheck_instanceof
	__constructor__J1_typecheck_instanceof__J1_typecheck_instanceof:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
