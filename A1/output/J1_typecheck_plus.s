...
section .data
	...
	global __class_J1_typecheck_plus
__class_J1_typecheck_plus:
		global __ref_SIT_J1_typecheck_plus
	__ref_SIT_J1_typecheck_plus:
		dd 0

		global __ref_PARENTS_J1_typecheck_plus
	__ref_PARENTS_J1_typecheck_plus:
	...
	; Methods	
		...
		dd __STATIC_method__J1_typecheck_plus__test
...
mov ebx, __ref_SIT_J1_typecheck_plus
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_typecheck_plus__test
	__STATIC_method__J1_typecheck_plus__test:
		push ebp
		mov ebp, esp
		...
		mov eax, 123
		jmp _method_return___STATIC_method__J1_typecheck_plus__test

		_method_return___STATIC_method__J1_typecheck_plus__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_typecheck_plus__J1_typecheck_plus
	__constructor__J1_typecheck_plus__J1_typecheck_plus:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
