...
section .data
	...
	global __class_J1_fieldinit_forward_ref2
__class_J1_fieldinit_forward_ref2:
		global __ref_SIT_J1_fieldinit_forward_ref2
	__ref_SIT_J1_fieldinit_forward_ref2:
		dd 0

		global __ref_PARENTS_J1_fieldinit_forward_ref2
	__ref_PARENTS_J1_fieldinit_forward_ref2:
	...
	; Methods	
		...
		dd __STATIC_method__J1_fieldinit_forward_ref2__test
...
mov ebx, __ref_SIT_J1_fieldinit_forward_ref2
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_fieldinit_forward_ref2__test
	__STATIC_method__J1_fieldinit_forward_ref2__test:
		push ebp
		mov ebp, esp

		;; field access
		;; ---new [J1_fieldinit_forward_ref2] ()
		;; Allocating size of 12
		mov eax, 12
				call __malloc
					mov ebx, __class_J1_fieldinit_forward_ref2
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_fieldinit_forward_ref2__J1_fieldinit_forward_ref2
		add esp, 0
		pop eax

		;; ---end of new [J1_fieldinit_forward_ref2] ()
		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J1_fieldinit_forward_ref2__test

		_method_return___STATIC_method__J1_fieldinit_forward_ref2__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_fieldinit_forward_ref2__J1_fieldinit_forward_ref2
	__constructor__J1_fieldinit_forward_ref2__J1_fieldinit_forward_ref2:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
