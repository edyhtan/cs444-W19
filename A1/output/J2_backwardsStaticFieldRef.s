...
extern __field_J2_backwardsStaticFieldRef_field2
extern __field_J2_backwardsStaticFieldRef_field1
...
section .data
	...
	global __class_J2_backwardsStaticFieldRef
__class_J2_backwardsStaticFieldRef:
		global __ref_SIT_J2_backwardsStaticFieldRef
	__ref_SIT_J2_backwardsStaticFieldRef:
		dd 0

		global __ref_PARENTS_J2_backwardsStaticFieldRef
	__ref_PARENTS_J2_backwardsStaticFieldRef:
	...
	; Methods	
		...
		dd __STATIC_method__J2_backwardsStaticFieldRef__test

;; Static fields
		global __field_J2_backwardsStaticFieldRef_field2
	__field_J2_backwardsStaticFieldRef_field2		dd 0

		global __field_J2_backwardsStaticFieldRef_field1
	__field_J2_backwardsStaticFieldRef_field1		dd 0
...
mov ebx, __ref_SIT_J2_backwardsStaticFieldRef
mov [ebx], eax
...
;; Static Field: __field_J2_backwardsStaticFieldRef_field2
mov eax, 3
mov ebx, __field_J2_backwardsStaticFieldRef_field2
mov [ebx], eax

;; Static Field: __field_J2_backwardsStaticFieldRef_field1
mov eax, 3
mov ebx, __field_J2_backwardsStaticFieldRef_field1
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J2_backwardsStaticFieldRef__test
	__STATIC_method__J2_backwardsStaticFieldRef__test:
		push ebp
		mov ebp, esp

		
		mov eax, __field_J2_backwardsStaticFieldRef_field1
		mov eax, [eax]

		jmp _method_return___STATIC_method__J2_backwardsStaticFieldRef__test

		_method_return___STATIC_method__J2_backwardsStaticFieldRef__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J2_backwardsStaticFieldRef__J2_backwardsStaticFieldRef
	__constructor__J2_backwardsStaticFieldRef__J2_backwardsStaticFieldRef:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
...
;; Field init:: field1
				...
				mov eax, __field_J2_backwardsStaticFieldRef_field2
				mov eax, [eax]
