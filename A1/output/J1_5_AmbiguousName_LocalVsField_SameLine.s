...
section .data
	...
	global __class_J1_5_AmbiguousName_LocalVsField_SameLine
__class_J1_5_AmbiguousName_LocalVsField_SameLine:
		global __ref_SIT_J1_5_AmbiguousName_LocalVsField_SameLine
	__ref_SIT_J1_5_AmbiguousName_LocalVsField_SameLine:
		dd 0

		global __ref_PARENTS_J1_5_AmbiguousName_LocalVsField_SameLine
	__ref_PARENTS_J1_5_AmbiguousName_LocalVsField_SameLine:
	...
	; Methods	
		...
		dd __method__J1_5_AmbiguousName_LocalVsField_SameLine__method
		dd __STATIC_method__J1_5_AmbiguousName_LocalVsField_SameLine__test
...
;; -----Methods-----
		global __method__J1_5_AmbiguousName_LocalVsField_SameLine__method
	__method__J1_5_AmbiguousName_LocalVsField_SameLine__method:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___method__J1_5_AmbiguousName_LocalVsField_SameLine__method

		_method_return___method__J1_5_AmbiguousName_LocalVsField_SameLine__method:
			mov esp, ebp
			pop ebp
			ret
...
mov ebx, __ref_SIT_J1_5_AmbiguousName_LocalVsField_SameLine
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_5_AmbiguousName_LocalVsField_SameLine__test
	__STATIC_method__J1_5_AmbiguousName_LocalVsField_SameLine__test:
		push ebp
		mov ebp, esp

		;; ---declare j
		;; ---new [J1_5_AmbiguousName_LocalVsField_SameLine] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_5_AmbiguousName_LocalVsField_SameLine
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_5_AmbiguousName_LocalVsField_SameLine__J1_5_AmbiguousName_LocalVsField_SameLine
		add esp, 0
		pop eax

		;; ---end of new [J1_5_AmbiguousName_LocalVsField_SameLine] ()
		...
		jmp _method_return___STATIC_method__J1_5_AmbiguousName_LocalVsField_SameLine__test

		_method_return___STATIC_method__J1_5_AmbiguousName_LocalVsField_SameLine__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_5_AmbiguousName_LocalVsField_SameLine__J1_5_AmbiguousName_LocalVsField_SameLine
	__constructor__J1_5_AmbiguousName_LocalVsField_SameLine__J1_5_AmbiguousName_LocalVsField_SameLine:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
