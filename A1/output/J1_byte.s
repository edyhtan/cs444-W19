...
section .data
	...
	global __class_J1_byte
__class_J1_byte:
		global __ref_SIT_J1_byte
	__ref_SIT_J1_byte:
		dd 0

		global __ref_PARENTS_J1_byte
	__ref_PARENTS_J1_byte:
	...
	; Methods	
		...
		dd __STATIC_method__J1_byte__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_byte__test
	__STATIC_method__J1_byte__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args:
		call __constructor__J1_byte__J1_byte
		add esp, 0
		pop eax
		...
		mov eax, [eax]
				...
				jmp _method_return___STATIC_method__J1_byte__test

		_method_return___STATIC_method__J1_byte__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_byte__J1_byte
	__constructor__J1_byte__J1_byte:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
