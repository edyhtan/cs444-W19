...
section .data
	...
	global __class_J1_ArrayInterfaces
__class_J1_ArrayInterfaces:
		global __ref_SIT_J1_ArrayInterfaces
	__ref_SIT_J1_ArrayInterfaces:
		dd 0

		global __ref_PARENTS_J1_ArrayInterfaces
	__ref_PARENTS_J1_ArrayInterfaces:
	...
	; Methods	
		...
		dd __STATIC_method__J1_ArrayInterfaces__test
...
mov ebx, __ref_SIT_J1_ArrayInterfaces
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_ArrayInterfaces__test
	__STATIC_method__J1_ArrayInterfaces__test:
		push ebp
		mov ebp, esp
		...
		mov eax, 123
		jmp _method_return___STATIC_method__J1_ArrayInterfaces__test

		_method_return___STATIC_method__J1_ArrayInterfaces__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_ArrayInterfaces__J1_ArrayInterfaces
	__constructor__J1_ArrayInterfaces__J1_ArrayInterfaces:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
