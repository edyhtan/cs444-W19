...
section .data
	...
	global __class_J1_boolean
__class_J1_boolean:
		global __ref_SIT_J1_boolean
	__ref_SIT_J1_boolean:
		dd 0

		global __ref_PARENTS_J1_boolean
	__ref_PARENTS_J1_boolean:
	...
	; Methods	
		...
		dd __STATIC_method__J1_boolean__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_boolean__test
	__STATIC_method__J1_boolean__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args:
		call __constructor__J1_boolean__J1_boolean
		add esp, 0
		pop eax

		;; ---end of new [J1_boolean] ()
		...
		;thenClause ...
			mov eax, 123
			jmp _method_return___STATIC_method__J1_boolean__test
		...
		_method_return___STATIC_method__J1_boolean__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_boolean__J1_boolean
	__constructor__J1_boolean__J1_boolean:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
