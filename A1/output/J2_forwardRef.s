...
extern __field_J2_forwardRef_b
...
section .data
	...
	global __class_J2_forwardRef
__class_J2_forwardRef:
		global __ref_SIT_J2_forwardRef
	__ref_SIT_J2_forwardRef:
		dd 0

		global __ref_PARENTS_J2_forwardRef
	__ref_PARENTS_J2_forwardRef:
	...
	; Methods	
		...
		dd __STATIC_method__J2_forwardRef__test

;; Static fields
		global __field_J2_forwardRef_b
	__field_J2_forwardRef_b		dd 0
...
mov ebx, __ref_SIT_J2_forwardRef
mov [ebx], eax
...
;; Static Field: __field_J2_forwardRef_b
mov eax, 3
mov ebx, __field_J2_forwardRef_b
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J2_forwardRef__test
	__STATIC_method__J2_forwardRef__test:
		push ebp
		mov ebp, esp
		...
		mov eax, __field_J2_forwardRef_b
		mov eax, [eax]
		...
		jmp _method_return___STATIC_method__J2_forwardRef__test

		_method_return___STATIC_method__J2_forwardRef__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J2_forwardRef__J2_forwardRef
	__constructor__J2_forwardRef__J2_forwardRef:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
