...
section .data
	...
	global __class_J1_ByteInit
__class_J1_ByteInit:
		global __ref_SIT_J1_ByteInit
	__ref_SIT_J1_ByteInit:
		dd 0

		global __ref_PARENTS_J1_ByteInit
	__ref_PARENTS_J1_ByteInit:
	...
	; Methods	
		...
		dd __STATIC_method__J1_ByteInit__test
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_ByteInit__test
	__STATIC_method__J1_ByteInit__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_ByteInit__test

		_method_return___STATIC_method__J1_ByteInit__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_ByteInit__J1_ByteInit
	__constructor__J1_ByteInit__J1_ByteInit:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
