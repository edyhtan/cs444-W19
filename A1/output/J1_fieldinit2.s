...
section .data
	...
	global __class_J1_fieldinit2
__class_J1_fieldinit2:
		global __ref_SIT_J1_fieldinit2
	__ref_SIT_J1_fieldinit2:
		dd 0

		global __ref_PARENTS_J1_fieldinit2
	__ref_PARENTS_J1_fieldinit2:
	...
	; Methods	
		...
		dd __STATIC_method__J1_fieldinit2__test
...
mov ebx, __ref_SIT_J1_fieldinit2
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_fieldinit2__test
	__STATIC_method__J1_fieldinit2__test:
		push ebp
		mov ebp, esp

				mov eax, 123
		jmp _method_return___STATIC_method__J1_fieldinit2__test

		_method_return___STATIC_method__J1_fieldinit2__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_fieldinit2__J1_fieldinit2
	__constructor__J1_fieldinit2__J1_fieldinit2:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
