...
section .data
	...
	global __class_J1_nestedcast
__class_J1_nestedcast:
		global __ref_SIT_J1_nestedcast
	__ref_SIT_J1_nestedcast:
		dd 0

		global __ref_PARENTS_J1_nestedcast
	__ref_PARENTS_J1_nestedcast:
	...
	; Methods	
		...
		dd __STATIC_method__J1_nestedcast__test
...
mov ebx, __ref_SIT_J1_nestedcast
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_nestedcast__test
	__STATIC_method__J1_nestedcast__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_nestedcast__test

		_method_return___STATIC_method__J1_nestedcast__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_nestedcast__J1_nestedcast
	__constructor__J1_nestedcast__J1_nestedcast:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
