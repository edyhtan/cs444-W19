...
section .data
	...
	global __class_J1_nonthisfieldaccess
__class_J1_nonthisfieldaccess:
		global __ref_SIT_J1_nonthisfieldaccess
	__ref_SIT_J1_nonthisfieldaccess:
		dd 0

		global __ref_PARENTS_J1_nonthisfieldaccess
	__ref_PARENTS_J1_nonthisfieldaccess:
	...
	; Methods	
		...
		dd __STATIC_method__J1_nonthisfieldaccess__test
...
mov ebx, __ref_SIT_J1_nonthisfieldaccess
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_nonthisfieldaccess__test
	__STATIC_method__J1_nonthisfieldaccess__test:
		push ebp
		mov ebp, esp

		;; ---declare obj
		;; ---new [J1_nonthisfieldaccess] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J1_nonthisfieldaccess
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_nonthisfieldaccess__J1_nonthisfieldaccess
		add esp, 0
		pop eax

		;; ---end of new [J1_nonthisfieldaccess] ()
		...
		jmp _method_return___STATIC_method__J1_nonthisfieldaccess__test

		_method_return___STATIC_method__J1_nonthisfieldaccess__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_nonthisfieldaccess__J1_nonthisfieldaccess
	__constructor__J1_nonthisfieldaccess__J1_nonthisfieldaccess:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
