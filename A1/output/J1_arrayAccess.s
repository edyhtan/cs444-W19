...
section .data
	...
	global __class_J1_arrayAccess
__class_J1_arrayAccess:
		global __ref_SIT_J1_arrayAccess
	__ref_SIT_J1_arrayAccess:
		dd 0

		global __ref_PARENTS_J1_arrayAccess
	__ref_PARENTS_J1_arrayAccess:
	...
	; Methods	
		...
		dd __STATIC_method__J1_arrayAccess__test
...
mov ebx, __ref_SIT_J1_arrayAccess
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_arrayAccess__test
	__STATIC_method__J1_arrayAccess__test:
		push ebp
		mov ebp, esp
		...
		jmp _method_return___STATIC_method__J1_arrayAccess__test

		_method_return___STATIC_method__J1_arrayAccess__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_arrayAccess__J1_arrayAccess
	__constructor__J1_arrayAccess__J1_arrayAccess:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
