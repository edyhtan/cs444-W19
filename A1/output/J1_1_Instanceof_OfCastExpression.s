...
__class_J1_1_Instanceof_OfCastExpression:
	...
	__ref_SIT_J1_1_Instanceof_OfCastExpression:
		dd 0

		global __ref_PARENTS_J1_1_Instanceof_OfCastExpression
	__ref_PARENTS_J1_1_Instanceof_OfCastExpression:
	...
	; Methods	
		...
		dd __STATIC_method__J1_1_Instanceof_OfCastExpression__test
...
mov ebx, __ref_SIT_J1_1_Instanceof_OfCastExpression
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_1_Instanceof_OfCastExpression__test
	__STATIC_method__J1_1_Instanceof_OfCastExpression__test:
		push ebp
		mov ebp, esp

		;; ---declare o
		;; ---new [J1_1_Instanceof_OfCastExpression] ()
		;; Allocating size of 4
		mov eax, 4
				call __malloc
					mov ebx, __class_J1_1_Instanceof_OfCastExpression
		mov [eax], ebx
		...
		;; Pushing args:
		call __constructor__J1_1_Instanceof_OfCastExpression__J1_1_Instanceof_OfCastExpression
		add esp, 0
		pop eax

		;; ---end of new [J1_1_Instanceof_OfCastExpression] ()
		...
		;thenClause ...
			mov eax, 123
			jmp _method_return___STATIC_method__J1_1_Instanceof_OfCastExpression__test
		...
		_method_return___STATIC_method__J1_1_Instanceof_OfCastExpression__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_1_Instanceof_OfCastExpression__J1_1_Instanceof_OfCastExpression
	__constructor__J1_1_Instanceof_OfCastExpression__J1_1_Instanceof_OfCastExpression:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
