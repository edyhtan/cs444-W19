...
section .data
	...
	global __class_J2_exactMatchConstructor3
__class_J2_exactMatchConstructor3:
		global __ref_SIT_J2_exactMatchConstructor3
	__ref_SIT_J2_exactMatchConstructor3:
		dd 0

		global __ref_PARENTS_J2_exactMatchConstructor3
	__ref_PARENTS_J2_exactMatchConstructor3:
		dd 1000010000000100b
	...
	; Methods	
		...
		dd __STATIC_method__J2_exactMatchConstructor3__test
...
mov ebx, __ref_SIT_J2_exactMatchConstructor3
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J2_exactMatchConstructor3__test
	__STATIC_method__J2_exactMatchConstructor3__test:
		push ebp
		mov ebp, esp

		;; field access
		;; ---new [J2_exactMatchConstructor3] ()
		;; Allocating size of 8
		mov eax, 8
				call __malloc
					mov ebx, __class_J2_exactMatchConstructor3
		mov [eax], ebx
		...
		call __constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$java_lang_Object$
		add esp, 4
		pop eax

		;; ---end of new [J2_exactMatchConstructor3] ()
		mov eax, [eax+4]
		jmp _method_return___STATIC_method__J2_exactMatchConstructor3__test

		_method_return___STATIC_method__J2_exactMatchConstructor3__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$java_lang_Object$
	__constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$java_lang_Object$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
...
;; Epilogue
		...
		pop ebp
		ret
		global __constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$java_io_Serializable$
	__constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$java_io_Serializable$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
...
;; Epilogue
		...
		pop ebp
		ret
		global __constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$J2_exactMatchConstructor3$
	__constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3$J2_exactMatchConstructor3$:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 12]
		push eax
...
;; Epilogue
		...
		pop ebp
		ret
		global __constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3
	__constructor__J2_exactMatchConstructor3__J2_exactMatchConstructor3:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
