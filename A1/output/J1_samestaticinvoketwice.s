...
extern __STATIC_method__java_lang_System__gc
...
section .data
	...
	global __class_J1_samestaticinvoketwice
__class_J1_samestaticinvoketwice:
		global __ref_SIT_J1_samestaticinvoketwice
	__ref_SIT_J1_samestaticinvoketwice:
		dd 0

		global __ref_PARENTS_J1_samestaticinvoketwice
	__ref_PARENTS_J1_samestaticinvoketwice:
	...
	; Methods	
		...
		dd __STATIC_method__J1_samestaticinvoketwice__test
...
mov ebx, __ref_SIT_J1_samestaticinvoketwice
mov [ebx], eax
...
global @@@@main
@@@@main:
		global __STATIC_method__J1_samestaticinvoketwice__test
	__STATIC_method__J1_samestaticinvoketwice__test:
		push ebp
		mov ebp, esp
		...
		;; Pushing args
		;; static method:
		call __STATIC_method__java_lang_System__gc
		...
		;; ---End of method invocation
		mov eax, 123
		jmp _method_return___STATIC_method__J1_samestaticinvoketwice__test

		_method_return___STATIC_method__J1_samestaticinvoketwice__test:
			mov esp, ebp
			pop ebp
			ret

;; -----Constructors-----
		global __constructor__J1_samestaticinvoketwice__J1_samestaticinvoketwice
	__constructor__J1_samestaticinvoketwice__J1_samestaticinvoketwice:
		push ebp
		mov ebp, esp
		mov eax, [ebp + 8]
		push eax
